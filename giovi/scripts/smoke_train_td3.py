...
Usage:
    python giovi/scripts/smoke_train_td3.py dexmg-bc/<run_id>
    python giovi/scripts/smoke_train_td3.py dexmg-bc/<run_id> --dry-run
    python giovi/scripts/smoke_train_td3.py dexmg-bc/<run_id> algo.total_timesteps=1000
"""
