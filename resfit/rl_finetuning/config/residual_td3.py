...
@dataclass
class ResidualTD3CubeToContainerConfig(ResidualTD3DexmgConfig):
    """Single-arm Panda pick-and-place, registered by the `simple_env` package.
    ...
    offline_data: OfflineDataConfig = field(
        default_factory=lambda: OfflineDataConfig(
            name="giovipeg/cube-to-container",
            num_episodes=200,
        )
    )
